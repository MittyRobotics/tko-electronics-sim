...
PACKAGE_NAME="tko-electronics-sim"
...
cp copyright $TEMP_DIR/debian/usr/share/doc/$PACKAGE_NAME/ # results in no copyright warning
...
echo " -- Rohan Bansal <rohan@rbansal.dev>  `date -R`" >> changelog
