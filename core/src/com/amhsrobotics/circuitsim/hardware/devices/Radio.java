...
public class Radio extends Hardware {

    public Radio(Vector2 position, HardwareType type) {
        super(position);

        this.type = type;

        JSONReader.loadConfig("scripts/Radio.json");
        base = new Sprite(new Texture(Gdx.files.internal("img/hardware/Radio.png")));
